...
import { getMySheets, generateBasicSheet, generateDeepSheet, setLeetcodeUsername, updateProfile, syncLeetcodeData, syncLeetcodeRawChunk, syncLeetcodeAggregate, getLeetcodeSyncStatus, getDashboardStats } from '../controllers/users.controller.js';
...
usersRouter.get('/dashboard', getDashboardStats);
